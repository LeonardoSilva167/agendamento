...
@section('content')
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @if ($data->status_id == 1)
                                            <a href="{{route('agendamentos-selecionar-instalador',$data->getKey())}}" title="Selecionar Instalador"
                                                class="btn btn-sm btn-success pull-right edit">
                                                <i class="voyager-person"></i> <span
                                                class="hidden-xs hidden-sm">Selecionar Instalador</span>
                                            </a>
                                            @endif
                                        </td>
                                    </tr>
    ...
    {{-- Single delete modal --}}
    <div class="modal modal-success fade" tabindex="-1" id="addInstalador" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('voyager::generic.close') }}"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Selecione o instalador!</h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('voyager.'.$dataType->slug.'.index') }}" id="update_form" method="POST">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        <div class="form-group col-md-12 text-left">
                            <label class="control-label" for="name">Instalador</label>
                            <select class="form-control select2-ajax select2-hidden-accessible" name="instalador_id">
